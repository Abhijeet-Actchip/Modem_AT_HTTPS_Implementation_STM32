...
#define EC200_CMD_TO_QMTOPEN            (120000)    /*!< Timeout value for QMTOPEN command */
...
typedef enum _ec200_ssl_seclevel_t
{
    ...
    EC200_SSL_SECLEVEL_2 /*!< Perform server and client authentication if requested by the remote server  */
